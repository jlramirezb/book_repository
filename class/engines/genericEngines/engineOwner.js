...
function cleanDataJ(countInput_9) {
  ...
  console.log("countInput_9",countInput_9)
...
function cleanDataQ(artefacto) {
  ...
  // result.typeArtifact = 'Standard';
  artefacto.typeArtifact == "Evaluation" ? (result.typeArtifact = 'Evaluation') : (result.typeArtifact = 'Standard')
...
function generateInput(question, isSimple) {
  ...
  if (isSimple === true) {
    ...
    if (question.placeholder) {
      ...
      mathInput.setAttribute('style', ' align-items:center');
