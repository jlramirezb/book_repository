    ...
    curves: [
      {
        ...
        points: [
          [-1.40, 0.44], [-1.14, 1], [-0.9, 1.40], [0.20, 2.44], [2.50, 3.20], [5.572, 3.20]
        ],
      },
      {
        interactive: true,
        strokeColor: 'purple',
        points: [
          [-1.40, 3.20], [2.50, 3.20], [5.0, 1.53], [5.572, 0.44]
        ],
      },
    ],
    lines: [
    ...
    curves: [
      {
        ...
        strokeColor: 'purple',
        points: [
          [-0.4, 0.2], [-0.3, 0.74], [-0.06, 1.44], [0.43, 2.10], [1.03, 2.47], [1.60, 2.67], [2.32, 2.67], [2.84, 2.52], [3.41, 2.24], [3.96, 1.68], [4.26, 1.02], [4.5, 0.22]
        ],
      },
      {
        interactive: true,
        strokeColor: 'darkorange',
        points: [
          [-0.4, 5], [-0.3, 4.61], [-0.06, 4.02], [0.43, 3.32], [1.03, 2.92], [1.60, 2.75], [2.32, 2.73], [2.84, 2.85], [3.41, 3.22], [3.96, 3.85], [4.38, 4.61], [4.5, 5.01]
        ],
      },
    ...
    curves: [
      {
        ...
        points: [
          ...
          [-1.6, 1.42], [-1.15, 2.09], [-0.17, 2.68], [1.17, 3.01], [2.56, 3.22], [4.98, 3.51]
        ],
      },
      {
        interactive: true,
        strokeColor: 'purple',
        points: [
          [-1.6, 0.42], [-1.15, 1.09], [-0.17, 1.68], [1.17, 2.01], [2.56, 2.22], [4.98, 2.51]
