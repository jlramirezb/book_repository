...
const def =
{
  ...
  artifact_2: {
    ...
    instructionText: {
      text: '-\\exponentialE^{\\left(\\space\\left)',
      styleClass: ['producto']
  ...
  artifact_3: {
    curveCount: 1,
    instructionText: {
      text: '-\\left\\vert\\space\\right\\vert',
      styleClass: ['producto']
  ...
  artifact_6: {
    ...
    instructionText: {
      text: 'ojo!\\space\\ y=\\left(-x\\right)^2',
      styleClass: ['producto']
